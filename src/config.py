...
from models import (BertForRelationIdentification, RoBERTaForRelationIdentification,
                    ...
                    MegatronForRelationIdentification, GatortronForRelationIdentification)
...
MODEL_REQUIRE_SEGMENT_ID = {'bert', 'xlnet', 'albert', 'deberta', 'megatron', 'gatortron'}
...
MODEL_DICT = {
    ...
    "gatortron":  (GatortronForRelationIdentification, MegatronBertConfig, BertTokenizer)
}
